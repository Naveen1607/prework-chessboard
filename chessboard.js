...
function changeDirection(note, move) {
    var direction = note.direction;
    switch (direction) {
        case 'S':
        case 's':
            moveForward(note.position, direction, move);
            break;
        case 'N':
        case 'n':
            moveBackward(note.position, direction, move);
            break;
        case 'W':
        case 'w':
            moveLeft(note.position, direction, move);
            break;
    }
}
